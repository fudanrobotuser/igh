...
const static ec_pdo_entry_reg_t domain1_regs[] = {
    {0, 0, ElmoVidPid, 0x607a, 0, &offset[0].target_position},
    {0, 0, ElmoVidPid, 0x60fe, 0, &offset[0].DO},
    {0, 0, ElmoVidPid, 0x6040, 0, &offset[0].ctrl_word},
    
    {0, 0, ElmoVidPid, 0x6064, 0, &offset[0].act_position},
    {0, 0, ElmoVidPid, 0x60fd, 0, &offset[0].DI},    
    {0, 0, ElmoVidPid, 0x6041, 0, &offset[0].status_word},
